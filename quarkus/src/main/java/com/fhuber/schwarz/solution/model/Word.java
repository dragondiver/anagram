 ...
 * this object can create a key build out of a sorted string of the underlying
 * "word" string
 * 
...
public class Word {
    ...
    /**
     * this key is build from the word reduced to alphanumeric characters and
     * sorted, thus all anagrams will have the same key
     * 
     * @return String
     */
